...
- (void)sk_presentViewController:(NSString *_Nonnull)viewController params:(NSDictionary *_Nonnull)params animated:(BOOL)animated;
- (void)sk_presentViewController:(NSString *_Nonnull)viewController params:(NSDictionary *_Nonnull)params animated:(BOOL)animated completion:(void (^__nullable)(void))completion;
@end
